...
from diffusha.data_collection.env.block_pushing import (
    ...
    block_pushing_multimodal_1block,
)

try:
    from diffusha.data_collection.env.block_push_env_test import (  # pylint: disable=g-import-not-at-top
        d4rl_utils,
    )
except ImportError as e:
    print("WARNING: Could not import d4rl. Error: ", e)
from tf_agents.environments import (  # pylint: disable=g-import-not-at-top
